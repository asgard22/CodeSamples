...
bool DateTime::operator<(const DateTime& other)
{
  ...
  // //results in number contained within thisTimeINT in the form: year month day hour minute second

  // for (int i = 0; i < 6; ++i)
  // {
  //   ss << theseTimeComponents[i];
  //   ss >> timeChunk;
  //   thisTimeSTR += timeChunk;
  //   ss.clear();
  // }

  // for (int i = thisTimeSTR.size(); i > 0; i--)
  // {
  //   int num = thisTimeSTR[thisTimeSTR.size()-i] - '0';
  //   thisTimeINT += num*((long)pow(10,i));
  // }

  // //results in number contained within otherTimeINT in the form: year month day hour minute second
  ...
  // for (int i = otherTimeSTR.size(); i > 0; i--)
  // {
  //   int num = otherTimeSTR[otherTimeSTR.size()-i] - '0';
  //   otherTimeINT += num*((long)pow(10,i));
  // }
