...
public class AddEventFromDayClickButton extends JButton implements ActionListener
{
	private AddEventGraphics eventGraphics;
	
	public AddEventFromDayClickButton(AddEventGraphics eventGraphics)
	{
		super("Add Event");
 	...
 	public void actionPerformed(ActionEvent e) 
	{
		...
		{
			if (eventGraphics.getStartTimeForDayClick().getTimeInMillis() > eventGraphics.getEndTimeForDayClick().getTimeInMillis())
			{
				JOptionPane warning = new JOptionPane();
				warning.showMessageDialog(eventGraphics.getCalGraphics(),
			...
			{
				Event someEvent = new Event(eventGraphics.getEventTitle(), eventGraphics.getEventLocation(), eventGraphics.getStartTimeForDayClick(), eventGraphics.getEndTimeForDayClick());
